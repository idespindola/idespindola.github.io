...
# Fiscal, contador e construtor de soluções

Sou Igor da Silva Espindola, contador registrado no CRC-RJ e Fiscal de Tributos do Município de Miracema/RJ. Atuo desde 2011 no setor público, com foco em gestão tributária municipal, fiscalização de ISS, análise de dados e automação de rotinas.
...
Programação, para mim, é uma extensão da contabilidade e da fiscalização: serve para automatizar, conferir, comparar e documentar.
:::
...
::: {.timeline}
::: {.timeline-item}
### Fiscal de Tributos de Miracema/RJ
