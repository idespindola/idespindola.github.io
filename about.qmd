...
Sou Igor da Silva Espindola, contador registrado no CRC-RJ, Fiscal de Tributos Municipal em Miracema/RJ e fundador da IDESPINDOLA SISTEMAS. Atuo desde 2011 no setor público, com foco em gestão tributária municipal, fiscalização de ISS, análise de dados, automação de rotinas e desenvolvimento de sistemas especialistas.
...
Iniciativa voltada ao desenvolvimento de sistemas especialistas, automações e soluções técnicas para rotinas contábeis, fiscais e tributárias.
:::
